...
export const getUserLocationMemoryTool = (config) => tool({
    name: "get_user_location_memory",
    description: "Fetches the user's saved preferred location/suburb/city for weather forecasts from long-term memory. Returns an empty string if no preference is saved — in that case default to 'Mascot'.",
    parameters: z.object({
        query: z
            .string()
