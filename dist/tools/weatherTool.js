...
export const getWeatherTool = (config) => tool({
    name: "get_weather",
    description: "Fetches the current weather and today's forecast for a Sydney-area location. Call get_user_location_memory first to determine which location to use, or default to 'Mascot' if no preference is found.",
    parameters: z.object({
        location: z
            .string()
