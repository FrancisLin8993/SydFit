...
mock.module("../src/googleCloudTask.js", { namedExports: { enqueueSydFitTask: mockEnqueueSydFitTask } });

const mockLoadConfig = mock.fn(() => ({ sydFitApiKey: "test-secret" }));
mock.module("../src/config.js", { namedExports: { loadConfig: mockLoadConfig } });
...
const mockDetermineIntent = mock.fn(async () => ({ intent: "weather", mode: null }));
